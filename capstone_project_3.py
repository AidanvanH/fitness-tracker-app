...
# MAKE SURE THERE ARE NO DUPLICATE METHODS, METHODS THAT HAVE DIFFERENT NAMES IN CLASSES BUT SERVES THE SAME PURPOSE
# DELETE KEY AND VALUE PAIRS FROM DICT ONCE THE FITNESS CATEGORY IS DELETED. (ONLY THE KEY IS REMOVING, NOT ITS VALUES)
# REMEMBER TO USE .rstrip()
